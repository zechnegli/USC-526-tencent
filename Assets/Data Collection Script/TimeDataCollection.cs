...
public class TimeDataCollection : MonoBehaviour
{
   ...
   // [SerializeField] private string URL = "https://docs.google.com/forms/u/0/d/e/1FAIpQLScFIaaUiglmTIbn9j4PF8WASIUWooj0AjCcfArKgDVCkVtEFg/formResponse";
   ...
   private long sessionID;
    ...
    private IEnumerator POST(string sessionID, string time){
        ...
        form.AddField("entry.246199246",sessionID);
        //new
         form.AddField("entry.1682110116",level);
        form.AddField("entry.1394138919",time);
